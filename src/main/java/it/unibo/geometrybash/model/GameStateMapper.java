...
public final class GameStateMapper {
     ...
     * The visibility window is approximately 20 meters wide(1920/96ppm). Since 5 meters
     ...
     */
    public GameStateDto toDto(final GameModel model) {
        ...
        return new GameStateDto(mapPlayer(player), obstacles, powerUp, cameraX, player.getCoins(), model.getStatus());
